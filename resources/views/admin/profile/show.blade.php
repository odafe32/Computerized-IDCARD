                ...
                <div class="bg-primary-subtle">
                    <div class="row">
                        ...
                        <div class="col-5 align-self-end">
                            <img src="{{ asset('assets/images/empty.png') }}" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.profile.edit') }}" class="btn btn-primary waves-effect waves-light">
                            <i class="mdi mdi-account-edit me-2"></i>Edit Profile
                        </a>
                        <a href="{{ route('admin.password.change') }}" class="btn btn-outline-secondary waves-effect">
